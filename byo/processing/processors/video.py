...
from byo.shared.models import ProcessResult
from byo.processing.processors.base import BaseProcessor
...
class VideoProcessor(BaseProcessor):
    ...
    async def extract(
        ...
        if source_url and ("youtube.com" in source_url or "youtu.be" in source_url):
            # Reject playlist URLs — they don't have a single video to transcribe.
            if "playlist" in source_url and "watch" not in source_url:
                return ProcessResult(markdown="", meta={
                    "error": "Playlist links aren't supported yet. Paste individual video links instead.",
                })
