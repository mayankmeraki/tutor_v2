...
def get_processor(mime_type: str) -> Processor:
    ...
    from byo.processing.processors.text import TextProcessor
...
def _register_builtins():
    ...
    from byo.processing.processors.video import VideoProcessor
    from byo.processing.processors.text import TextProcessor
    from byo.processing.processors.image import ImageProcessor
